...
public class TinyService implements CrudService{
	...
	public void read(String key,AsyncCallback<CrudObject> callback) {
		crudRpcService.readObject(key,Tiny.getCanonicalName(),callback);
	}
	...
	public void delete(String key,AsyncCallback<Message> callback) {
		crudRpcService.deleteObject(key,Tiny.getCanonicalName(),callback);
	}

	@Override
	public void getAll(AsyncCallback<ArrayList<CrudObject>> callback) {
		crudRpcService.getAll(Tiny.getCanonicalName(),callback);
	}
